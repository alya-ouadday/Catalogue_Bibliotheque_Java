...
/**
 * 
 * represente les documents qui sont des partitions qui appartiennent à une serie
...
public class PartitionInSerie extends Partition implements InSerie{
	 ...
	 * @param seriesNumber
	 */
	public PartitionInSerie(String ean,String title, String publisher, int date,
